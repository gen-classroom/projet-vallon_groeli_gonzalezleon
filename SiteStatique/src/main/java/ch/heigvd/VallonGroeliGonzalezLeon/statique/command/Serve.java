...
/**
 * The serve command. This command will launch the main index file of the site in the default browser.
 */
@CommandLine.Command(name = "serve", mixinStandardHelpOptions = true,
                     description = "Open the index.html file in the build file in default browser. This command " +
